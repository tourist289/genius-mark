...
function () {
  ...
  _createClass(KoModal, [{
    key: "_init",
    value: function _init() {
      var _this = this;

      //************ START window.MODAL.call
      var openModalButtons = Array.from(document.querySelectorAll('.js-modal'));
      openModalButtons.forEach(function (button) {
        button.addEventListener('click', function () {
          _this.open(button.dataset.modal);
        });
      }); //============ CLOSE on "close" button

      this.bodyElement.addEventListener('click', function (evt) {
        var target = evt.target;

        if (_this.checkClassList) {
          if (target.classList.contains('modal__overlay')) {
            _this.close();
          }
        }
      });
      var closeBtn = document.querySelectorAll('.js-modal__close');
    ...
    value: function open(id) {
      ...
      setTimeout(function () {
        ...
        _this2.bodyElement.classList.add(_this2.MODAL_OPEN);

        try {
          bodyScrollLock.disableBodyScroll(overlay);
        } catch (e) {
          console.log("Body Scroll Lock can't Call ---> ".concat(e));
        }
      }, 300);
    ...
    value: function close() {
      ...
      try {
        ...
        console.log("Body Scroll Lock can't Close ---> ".concat(e));
      }
    ...
    value: function _setPosition() {
      ...
      setTimeout(function () {
        if (modal.clientHeight > window.innerHeight) {
          ...
          // "CENTER"
          position['top'] = "".concat(window.innerHeight / 2, "px");
          position['marginTop'] = "-".concat(modal.clientHeight / 2, "px");
        }
    ...
    value: function _onPopupEscPress(evt) {
      if (this.checkClassList) {
        if (evt.keyCode === 27) this.close();
      }
    }
  }, {
    key: "_onOpenPopupResize",
    value: function _onOpenPopupResize() {
      if (this.checkClassList) {
        this._setPosition();
      }
    }
